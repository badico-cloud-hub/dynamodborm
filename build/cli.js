...
/***/ (function(module, exports, __webpack_require__) {
	...
	var cli = __webpack_require__(45);

	var _require = __webpack_require__(46),
	    Migration = _require.Migration,
	    getMigrationsFiles = _require.getMigrationsFiles;
	...
	function deploy(label, _ref) {
	    ...
	    var functor = 'up';
	    var migration = new Migration({ region: region }, {});
	    var ChangeLogRepository = migration.ChangeLogAggregator.Repository;

	    var domainsMigrationListFiles = getMigrationsFiles(domain);
	    return Promise.all(Object.keys(domainsMigrationListFiles).map(function (filename) {
	        var DomainAggregator = __webpack_require__(47)(filename);
	        ...
	        var listFns = resolveds.reduce(function (_fns, _ref2) {
	            var DomainAggregator = _ref2.DomainAggregator,
	                domain = _ref2.domain,
	                logs = _ref2.logs,
	                migrations = _ref2.migrations;

	            var _ref3 = logs[0] || {},
	                lastMigrationDeployed = _ref3.migrationName,
	                lastOperationDeployed = _ref3.operation;
	            ...
	            var filteredFns = migrationsToBeDeployed.map(function (_ref4) {
	                var migrationName = _ref4.migrationName,
	                    filepath = _ref4.filepath;

	                var fn = __webpack_require__(47)(filepath)[functor];
	                return {
	                    fn: fn,
	                    migrationName: migrationName,
	                    domain: domain,
	...
	function add(migrationName, _ref5) {
	    var kind = _ref5.kind;
	    ...
	    // __dirname,
	    'src', 'migrations', new Date().toISOString() + '_' + migrationName + '.js'), content, 'utf8');
	}

	cli.version('v0.1.0-beta.0', '-v, --version').description('DynamodbORM command line interface');

	cli.command('deploy <label>').option('-f, --force', 'Ignore the existence of actual instance').option('-r, --region [value]', 'Choose a region different from us-east-1').option('-d, --domain [value]', 'Name of domain for put up')
	// .option('-l, --label', 'Label for operation')
	.action(deploy);

	cli.command('rollback').option('-f, --force', 'Ignore the existence of actual instance').option('-d, --domain', 'Name of domain for put down').action(rollback);

	cli.command('add <migrationName>').option('-k, --kind [value]', 'The Kind of the migration') // table, seed, schema
	.action(add);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var map = {
		...
		"./cli": 43,
		"./cli.js": 43,
		"./default-migrations/default": 48,
		"./default-migrations/default.js": 48,
		"./deploy": 49,
		"./deploy.js": 49,
		...
		"./helpers/commonSchema": 50,
		"./helpers/commonSchema.js": 50,
		"./helpers/parseFields": 38,
		"./helpers/parseFields.js": 38,
		"./index": 18,
		"./index.js": 18,
		"./migrations/2018-11-14T12:07:49.548Z_myMigration": 51,
		"./migrations/2018-11-14T12:07:49.548Z_myMigration.js": 51,
		"./rollback": 52,
		"./rollback.js": 52
	};
